...
const Hero = () => {
  return (
    <section className="text-center p-4 pb-40 md:p-40 pt-36 flex justify-center items-center text-black relative overflow-hidden">
      <div className='mb-14 px-2'>
        <div className='flex flex-col items-center mb-2'>
          <h1 className="text-4xl md:text-7xl font-black mb-4">Your Currency and Spend it Borderlessly</h1>
        ...
        <div className="gap-4 flex justify-center flex-col md:flex-row">
      ...
      <div className='absolute -bottom-[23%] md:-bottom-2/4'>
