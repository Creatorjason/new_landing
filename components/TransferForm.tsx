...
const TransferForm = () => {
  ...
  return (
    <div className="bg-white p-10 max-w-xl rounded-xl text-[#141F1F] shadow-md">
      ...
      <div className="space-y-4 text-sm text-gray-500 p-1">
        <div>
        ...
        <div className='w-full border border-[#CECECE]'></div>
      ...
      <p className="text-sm text-black mt-2 mb-4">Should arrive by Thursday, August 22</p>
      <button className="w-full py-3 bg-[#141F1F] text-white rounded-full hover:bg-opacity-90 mt-4 font-semibold">
        Send Money Now
      </button>
    </div>
  );
